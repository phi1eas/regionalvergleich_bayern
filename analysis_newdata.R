...
std.plot(d = data.flaechen, "betrfl.rel", plot.title = "Anteil Betriebsfläche an Gesamtfläche", xlab = "Flächenanteil",  percent = T, upper_break = 0.06, x.ticks.n = 4)
...
# Schüler
std.plot(d = data.schueler, "schueler.insg.rel", "Schüler", xlab = "Anteil an Bevölkerung", percent = T, upper_break = 0.4)
...
# Bevölkerung
std.plot(COLLABELS$bevoelkerung.insgesamt, plot.title = "Bevölkerung 2017", xlab = "Bevölkerung", upper_break = 30000, x.ticks.n = 5)
...
# Bevölkerungsdichte
std.plot(COLLABELS$bevoelkerung.je_km2, plot.title = "Bevölkerungsdichte", xlab = "Einwohner je km²", upper_break = 1000, x.ticks.n = 6)

# Bevölkerungsbewegung Zugezogene
std.plot(COLLABELS$bevoelkerung.bewegung.zugezogene, "Bevölkerungsbewegung: Zugezogene (2017)", xlab = "Anzahl Zugezogener", upper_break = 2500)
std.plot(COLLABELS$bevoelkerung.bewegung.fortgezogene, "Bevölkerungsbewegung: Fortgezogene (2017)", xlab = "Anzahl Fortgezogener", upper_break = 2000, x.ticks.n = 6)
std.plot(COLLABELS$bevoelkerung.bewegung.wanderungsgewinn, "Bevölkerungsbew.: Wanderungsgewinn (2017)", xlab = "Wanderungsgewinn", lower_break = -80, upper_break = 300, x.ticks.n = 150)
...
std.plot(COLLABELS$erwerb.pendlersaldo, "Pendlersaldo", xlab = "Pendlersaldo", lower_break = -3000, upper_break = 4000)

# Landwirtschaft
std.plot(COLLABELS$landforst.betriebe_von_flaeche_ha.insgesamt, "Land- und forstwirtschaftliche Betriebe", xlab = "Anzahl Betriebe", upper_break = 200, x.ticks.n = 6)

# Wasser pro Kopf Verbrauch
std.plot(COLLABELS$umwelt.wasser_pro_kopf_verbrauch, "Wasserverbrauch", xlab = "Liter pro Person")

# Wohnungen
std.plot(COLLABELS$bauwohn.baugenehmigungen.wohnungen, "Erteilte Baugenehmigungen: Wohnungen (2017)", xlab = "Anzahl", upper_break = 200)
std.plot(COLLABELS$bauwohn.bestand_wohnungen.insgesamt, "Wohnungsbestand", xlab = "Anzahl", upper_break = 12000, x.ticks.n = 6)

# Finanzen
std.plot(COLLABELS$lohneinksteuer.gesamtbetrag_einkuenfte.insgesamt, "Lohn- und Eink.-St.: Gesamtbetrag der Einkünfte (2014)", xlab = "in 1000€", upper_break = 600000, x.ticks.n = 6)
...
std.plot(COLLABELS$lohneinksteuer.bruttolohn.je_arbeitnehmer, "Lohn- und Eink.-St.: Bruttolohn je Arbeitnehmer (2014)", xlab = "in €", upper_break = 50000, x.ticks.n = 4)
std.plot(COLLABELS$kommunale_finanzen.gemeindesteuereinnahmen.insgesamt, "Gemeindesteuereinnahmen: insgesamt", xlab = "in 1000€", upper_break = 40000, x.ticks.n = 4)
std.plot(COLLABELS$kommunale_finanzen.steuereinnahmen_insgesamt, "Steuereinnahmen: insgesamt", xlab = "in € je Einwohner", upper_break = 3000, x.ticks.n = 2)
...
std.plot(COLLABELS$kommunale_finanzen.gemeindesteuereinnahmen.darunter.grundsteuer.a, plot.title = "Gemeindesteuereinnahmen: Grundsteuer A", xlab = "in 1000€", upper_break = 200)
std.plot(COLLABELS$kommunale_finanzen.gemeindesteuereinnahmen.darunter.grundsteuer.b, plot.title = "Gemeindesteuereinnahmen: Grundsteuer B", xlab = "in 1000€", upper_break = 3000)
