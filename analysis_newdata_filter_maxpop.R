                  ...
                  std.plot(COLLABELS$bevoelkerung.bewegung.zugezogene, "Bevölkerungsbewegung: Zugezogene (2017)", xlab = "Anzahl Zugezogener", upper_break = 450)
                  std.plot(COLLABELS$bevoelkerung.bewegung.fortgezogene, "Bevölkerungsbewegung: Fortgezogene (2017)", xlab = "Anzahl Fortgezogener", upper_break = 450, x.ticks.n = 6)
                  ...
                  std.plot(COLLABELS$umwelt.wasser_pro_kopf_verbrauch, "Wasserverbrauch", xlab = "Liter pro Person", lower_break = 80, upper_break = 180)
                  ...
                  std.plot(COLLABELS$bauwohn.bestand_wohnungen.insgesamt, "Wohnungsbestand", xlab = "Anzahl", upper_break = 2300, x.ticks.n = 6)
                  ...
                  std.plot(COLLABELS$lohneinksteuer.bruttolohn.je_arbeitnehmer, "Lohn- und Eink.-St.: Bruttolohn je Arbeitnehmer (2014)", xlab = "in €", upper_break = 42000, x.ticks.n = 4)
                  std.plot(COLLABELS$kommunale_finanzen.gemeindesteuereinnahmen.insgesamt, "Gemeindesteuereinnahmen: insgesamt", xlab = "in 1000€", upper_break = 10000, x.ticks.n = 4)
                  std.plot(COLLABELS$kommunale_finanzen.steuereinnahmen_insgesamt, "Steuereinnahmen: insgesamt", xlab = "in € je Einwohner", lower_break = 0, upper_break = 3000, x.ticks.n = 2)
                  ...
                  std.plot(COLLABELS$kommunale_finanzen.steuereinnahmekraft.je_einwohner, "Steuereinnahmekraft", xlab = "in € je Einwohner", upper_break = 3000)
                  ...
                  std.plot(COLLABELS$kommunale_finanzen.gemeindesteuereinnahmen.darunter.grundsteuer.b, plot.title = "Gemeindesteuereinnahmen: Grundsteuer B", xlab = "in 1000€", upper_break = 800)
